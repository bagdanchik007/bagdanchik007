...
developer = {
    ...
    "role":       "Backend- & Systems-Entwickler",
    "goal":       "Ausbildung zum Fachinformatiker (Anwendungsentwicklung)",
    "backend":    ["Python", "FastAPI", "async REST-APIs", "SQLAlchemy (async)"],
    "databases":  ["PostgreSQL", "SQL", "Redis"],
    "systems":    ["C++", "x86_64", "Assembly", "Speicherverwaltung", "Paging", "Scheduling"],
    "frontend":   ["HTML", "CSS", "JavaScript"],
    "tools":      ["Git", "GitHub", "Docker", "Poetry"],
...
> Backend- und Systems-Entwickler mit Fokus auf Python (FastAPI, async REST-APIs) und C++ (Systemprogrammierung, x86_64) — strukturiert, lösungsorientiert und motiviert, mein Wissen in einem professionellen Ausbildungsumfeld einzubringen.
...
![Assembly](https://img.shields.io/badge/x86__64%20Assembly-6E4C13?style=for-the-badge&logo=assemblyscript&logoColor=white)
